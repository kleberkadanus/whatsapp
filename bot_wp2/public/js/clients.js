...
function saveClientInfo() {
  ...
  // Definir endpoint e método com base em novo ou existente
  ...
  apiRequest(endpoint, method, formData)
    .then(data => {
      ...
      // Atualizar título da modal
      document.getElementById('clientModalTitle').textContent = formData.name || 'Detalhes do Cliente';
      
      // Mostrar mensagem de sucesso
      showAlert('Sucesso', clientId ? 'Cliente atualizado com sucesso!' : 'Cliente adicionado com sucesso!');
    ...
    .catch(error => {
      ...
      showAlert('Erro', 'Não foi possível salvar as informações do cliente. Tente novamente.');
    });
}
